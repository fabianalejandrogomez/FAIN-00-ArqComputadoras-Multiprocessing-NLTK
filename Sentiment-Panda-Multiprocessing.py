...
if __name__ == '__main__':
    ...
    r1 = pool.apply_async(sentiment(verbatim))


    r2 = pool.apply_async(motive(verbatim))


    r3 = pool.apply_async(sentiment_analysis(verbatim))


    r4 = pool.apply_async(motive_analysis(verbatim))
    ...
    print('Tiempo en segundos (4 Processes) -', end - start)
